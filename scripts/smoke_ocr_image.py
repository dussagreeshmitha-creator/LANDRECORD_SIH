...
sample = Path("data/sample-land-record.png").read_bytes()
fields = {
    "owner_name": "R. Selvam",
...
parts.append(
    f"--{boundary}\r\nContent-Disposition: form-data; name=\"file\"; filename=\"sample-land-record.png\"\r\nContent-Type: image/png\r\n\r\n".encode()
    + sample
    + b"\r\n"
)
...
print(res["engine"], res["validation"]["overall"], res["validation"]["mismatch_count"])
